...
$(document).ready(function () {
    ...
    ymaps.ready(function () {
        ...
        if (app.getUrlParameter('x') && app.getUrlParameter('y') && app.getUrlParameter('project_id'))
    ...
    function whPlacemarkClick(e) {
        ...
        if (currentTypingRadius) {
            ...
            $('.wh__radius_input').each(function () { if ($(this).data('id') == clicked_wh.wh_id)
