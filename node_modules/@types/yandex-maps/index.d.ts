...
declare namespace ymaps {
    ...
    namespace control {
        ...
        type SearchControlProviderT = IGeocodeProvider | "yandex#map" | "yandex#search" | undefined;
        ...
        interface ISearchControlParameters {
            ...
            options?: {
                ...
                provider?: SearchControlProviderT;
    ...
    class Clusterer implements IChildOnMap, ICustomizable, IEventEmitter, IParentOnMap {
        ...
        getObjectState(geoObject: IGeoObject): { isShown: boolean; cluster: ClusterData; isClustered: boolean };
    ...
    class GeoObject<T = IGeometry, TargetGeometry extends {} = {}> implements IGeoObject<T> {
        constructor(feature?: FeatureData, options?: IGeoObjectOptions);
    ...
    interface IMapOptions {
        ...
        searchControlProvider?: ymaps.control.SearchControlProviderT
    ...
    class ObjectManager implements ICustomizable, IEventEmitter, IGeoObject, IParentOnMap {
        ...
        add(objects: FeatureData | FeatureCollection | (FeatureData | FeatureCollection)[] | string): this;
        ...
        getObjectState(id: string): { found: boolean; isShown: boolean; cluster?: ClusterData | undefined; isClustered: boolean; isFilteredOut: boolean };
    ...
    namespace objectManager {
        ...
        class ClusterCollection implements ICustomizable, IEventEmitter {
            ...
            getById(id: string | null | undefined): ClusterData | null;
        ...
        class ObjectCollection implements ICollection, ICustomizable {
            ...
            each(callback: (object: FeatureData) => void, context?: object): void;
        ...
        class LoadingObjectManager<T extends IGeometry> implements ICustomizable, IEventEmitter, IGeoObject, IParentOnMap {
            /**
             * 
