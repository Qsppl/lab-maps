...
type RemapType<Prefix extends string, Type> = {
    [Key in keyof Type as Key extends string ? CamelCasePrefix<Prefix, Key> : never]
}
...
declare namespace ymaps {
    ...
    namespace geometry {
        ...
        namespace json {
            /** @private */
            type Types = "FeatureCollection" | "Feature" | "Point" | "LineString" | "Polygon" | "Circle" | "Rectangle" | string
            ...
            > = IFeatureJson<GeometryJson, Options, Properties> & {
                type: "Cluster"
    ...
    namespace option {
        ...
        > implements IOptionManager<Options, ParentOptionManagerOptions> {
            ...
            // set<K extends keyof Options>({ }: { K: Options[K] }): this
    ...
    type ClusterPlacemarkOptions = RemapType<"balloon", IBalloonOptions> & {
        ...
        */
         ...
         */
        icons?: Array<{ href: string; size: number[]; offset: number[]; shape?: IShape | IGeometryJson | undefined; }> | undefined;
    ...
    namespace objectManager {
        ...
        type ClusterCollectionOptions<ChildPlacemarkOptions extends IOptionManagerData>
            = ChildPlacemarkOptions & {
        ...
        class ClusterCollection<
            ...
            PlacemarkOptions extends IOptionManagerData = ClusterPlacemarkOptions,
            // Опции коллекции и дефолтные опции для Placemark'ов кластеров
            Options extends IOptionManagerData = ClusterCollectionOptions<PlacemarkOptions>,
        ...
        type ObjectCollectionOptions<ChildPlacemarkOptions extends IOptionManagerData>
            = Pick<ChildPlacemarkOptions, "hideIconOnBalloonOpen" | "openBalloonOnClick"> & {
                /** Флаг наличия у коллекции поля .balloon. Если при клике на кластер не нужно открывать балун, рекомендуется установить эту опцию в значение false, чтобы избежать лишних инициализаций */
                hasBalloon?: boolean | undefined
                /** Флаг наличия у коллекции поля .hint. Если при наведении на кластер не нужно показывать всплывающую подсказку, рекомендуется установить эту опцию в значение false, чтобы избежать лишних инициализаций */
                hasHint?: boolean | undefined
        ...
        class ObjectCollection<
            TChildFeathure extends geometry.json.IFeatureJson<any, any, any>,
            ChildPlacemarkOptions extends IOptionManagerData,

            Options extends IOptionManagerData = ObjectCollectionOptions<ChildPlacemarkOptions>,
